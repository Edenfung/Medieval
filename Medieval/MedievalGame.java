...
public class MedievalGame {
  ...
  private void save() {
    ...
    playerSaver.writeObject(player);
      ...
      System.out.println("There was an error saving your game, your file might not be avaliable the next time you go to load a game.");
    } 
  ...
  private Player load(String playerName, Scanner console) {
    ...
    try {
      FileInputStream fileName = new FileInputStream(playerName + ".svr");
      ObjectInputStream input = new ObjectInputStream(fileName);

      loadedPlayer = (Player) input.readObject();
